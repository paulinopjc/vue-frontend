<template>
  <div class="p-6 max-w-4xl mx-auto">
    <div class="flex items-center justify-between mb-4">
      <h1 class="text-xl font-semibold text-gray-900">Task Manager — Users</h1>
      <button
...
async function load() {
  ...
  error.value = ''
  try {
    const res = await taskApi.listUsers()
